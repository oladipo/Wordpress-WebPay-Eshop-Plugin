...
if($wpdb->get_var("select id from ".$table." where id=12 limit 1")!='12')
		$wpdb->query("INSERT INTO ".$table." (id,emailType,emailSubject) VALUES ('10','".__('Automatic microzahlen email','eshop')."','$esubject')"); 		
